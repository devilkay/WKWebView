...
//  WKWebView
//
//  Created by @niukai on 2019/3/14.
//  Copyright © 2019 @niukai. All rights reserved.
//
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    ...
    ocButton.frame = CGRectMake(self.view.center.x - 40, SCREEN_HEIGHT - 100, 80, 40);
    [ocButton setTitle:@"OC调用JS" forState:UIControlStateNormal];
    [ocButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ocButton.titleLabel.font = [UIFont systemFontOfSize:14];
    
    [ocButton addTarget:self action:@selector(ocToJs) forControlEvents:UIControlEventTouchUpInside];
